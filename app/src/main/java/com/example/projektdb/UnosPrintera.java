    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                adapter.setOnItemClickListener(new PrinterAdapter.OnItemClickListener() {
                    ...
                    public void onClick(Printeri printeri) {
                        View view = LayoutInflater.from(UnosPrintera.this).inflate(R.layout.add_printeri_dialog, null);
        ...
        btnUnosPrintera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                        ...
                        View view1 = LayoutInflater.from(UnosPrintera.this).inflate(R.layout.add_printeri_dialog, null);
                        TextInputLayout titleLayout, contentLayout;
