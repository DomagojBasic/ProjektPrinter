...
public class PrinterAdapterLDC extends RecyclerView.Adapter<PrinterAdapterLDC.ViewHolder>{
    ...
    static PrinterAdapterLDC.OnItemClickListener onItemClickListener;


    public PrinterAdapterLDC(Context context, ArrayList<Printeri> arrayList) {
    ...
    public PrinterAdapterLDC.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.printeri_list_ldc1, parent, false);
        Log.e("proba1","ispisivanjeLDC");
    ...
    public void setOnItemClickListener(PrinterAdapterLDC.OnItemClickListener onItemClickListener) {
